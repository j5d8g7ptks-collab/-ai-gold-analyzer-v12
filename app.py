...
def load_gold(interval_value, period_value):
    ...
    for item in points:
        ...
        if ts is None or price is None:
            continue
        try:
            # XAUS intraday timestamps are Unix epoch milliseconds.
            # Without unit="ms", pandas treats numeric timestamps as nanoseconds,
            # which collapses the series near 1970 into one candle.
